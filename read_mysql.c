...
{
  char * sql = (argc > 1) ? argv[1] : "SELECT lat AS x, lon AS y, id AS unique_set_id FROM civicsets.points where created_at > '2011-03-16 20:00:00' and source = 'gps_reporter' ORDER BY unique_set_id";
