...
int main(int argc, char ** argv)
{
	...
	*/
	...
	char ellipsoid_string[10] = "nad83"; // silly toronto
	int ref_meridian = 0;
	
	struct ellipsoid e;
	get_geo_constants(&e, 5, xtm); // set by nad27 or wgs84
	/*
	if (strcmp(ellipsoid_string, "nad27") == 0 || strcmp(ellipsoid_string, "NAD27") == 0) e = geo_constants(5, xtm);
	else if (strcmp(ellipsoid_string, "nad83") == 0 || strcmp(ellipsoid_string, "NAD83") == 0) e = geo_constants(22, xtm);
	else if (strcmp(ellipsoid_string, "wgs84") == 0 || strcmp(ellipsoid_string, "WGS84") == 0) e = geo_constants(22, xtm);
	else
	{
